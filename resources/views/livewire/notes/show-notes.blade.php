...
new class extends Component {
    ...
    {
        return <<<'HTML'
        <div role="status" class="flex items-center justify-center w-full h-[70vh]">
                ...
                <x-card wire:key='{{ $note->id }}'>
                    <div class="flex justify-between">
                        <a href="#" class="text-xl font-bold hover:underline hover:text-blue-500"
                            href="{{ route('notes.edit', $note) }}" wire:navigate>
                            {{ $note->title }}
                        </a>
                    ...
                    <div class="flex items-end justify-between mt-4 space-x-1">
                        ...
                        <div>
                            <x-button.circle icon="eye" href="{{ route('notes.show', $note) }}" wire:navigate />
